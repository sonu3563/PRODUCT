...
function Tooltip({
  ...
  const colorClasses = (bg) => {
    switch (bg) {
      ...
      default:
        return 'text-gray-600 bg-white dark:text-gray-100 border-gray-200 dark:border-gray-700/60';
    }
  };    
  ...
  return (
    ...
    >
      <button className="block" aria-haspopup="true" aria-expanded={tooltipOpen} onClick={(e) => e.preventDefault()}>
        <svg className="fill-current text-white" width="16" height="16" viewBox="0 0 16 16">
